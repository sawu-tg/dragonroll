...
/mob/player/proc/randomise()
	var/choice = pick("Human","Golem","Lizard","Slime","Pod","Fly","Jelly","Ape","Spider","Spidertaur")
...
/mob/player/Topic(href,href_list[])
	...
	switch(function)
		if("name")
			...
			src.playerSheet()
		if("race")
			var/choice = input(src,"Choose your Race") as anything in list("Human","Golem","Lizard","Slime","Pod","Fly","Jelly","Ape","Spider","Spidertaur")
			var/chosen = text2path("/datum/race/[choice]")
			raceChange(chosen)
